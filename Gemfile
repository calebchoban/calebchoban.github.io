# This works for legacy GitHub Pages sites using Jekyll.
...
# Below is for newer version of Hydejack which uses Github Actions. 
# To use this I will need to make an entirely new repo from a downloaded copy
# since the pages setting is fixed for the forked repo........
